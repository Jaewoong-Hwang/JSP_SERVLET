	...
	<div class="wrapper">
		...
		<main class="layout">
			...
			<form action="${pageContext.request.contextPath}/book/update"
				method="post">
				<div>
					<label for="">bookCode : </label><span>${bookCode}</span><br /> <input
						type="text" name="bookCode" placeHolder="bookCode"
						value="${bookDto.bookCode}" readonly />
				</div>
				<div>
					<label for="">bookName : </label><span>${bookName}</span><br /> <input
						type="text" name="bookName" placeHolder="bookName"
						value="${bookDto.bookName}" />
				</div>
				<div>
				...
				<div>
					<button>도서수정</button>
					<a
						href="${pageContext.request.contextPath}/book/delete?${bookDto.bookCode}&pageno=${pageno}">도서삭제</a>
				</div>
			</form>
			...
			<div class="reply-block">
				...
				<div class="rely-header">
					...
					<div>
						...
						<a class="relply-add-btn" href="javascript:void(0)">입력</a>
					</div>
				</div>
